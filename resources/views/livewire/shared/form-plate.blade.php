<div>
    ...
    <x-danger-button wire:click="abrirModal()">Crear Plato</x-danger-button>
    <x-modificados-jet.modal wire:model="openModal" maxWidth="full" >
        <div class="cont_form_recipe">
            ...
            <!--form recetas-->
            <form class="form_recipe flex items-center">
                <div class="border-b border-gray-900/10 pb-12">
                    
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Información del Plato</h2>
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <!--titulo -->
                        <div class="sm:col-span-full">
                            <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Nombre del Plato</label>
                            <div class="mt-2">
                              <input  wire:model="name" type="text" name="name" placeholder="Ej: Bandeja Paisa" id="name" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
